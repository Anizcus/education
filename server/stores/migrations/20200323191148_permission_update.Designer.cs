...
namespace server.stores.migrations
{
    ...
    [Migration("20200323191148_permission_update")]
    partial class permission_update
    {
            ...
            modelBuilder.Entity("Server.Stores.Entities.RolePermission", b =>
                {
                    b.HasOne("Server.Stores.Entities.Permission", "Permission")
                        ...
                        .HasConstraintName("FOREIGN_ROLE_PERMISSION_PERMISSION_IDX")
                    ...
                    b.HasOne("Server.Stores.Entities.Role", "Role")
                        ...
                        .HasConstraintName("FOREIGN_ROLE_PERMISSION_ROLE_IDX")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
